...
```vim
:Lazy              " Wait for all plugins to install
...
- Create `~/vaults/` for the Obsidian plugin

### Automatic Setup

- **Lazy.nvim** installs all plugins on first launch
- **Mason** auto-installs LSP servers and tools (lua_ls, stylua, debug adapters)
- **Treesitter** auto-installs parsers when opening files
